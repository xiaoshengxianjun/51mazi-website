...
const features = [
  {
    id: 1,
    title: '专业编辑器',
    description: '基于 TipTap 的专业编辑器，支持人物高亮、禁词提示、段落拖拽等智能功能',
    icon: '✍️',
  ...
  },
  {
    id: 2,
    title: '地图设计',
    description: '专业级 Canvas 绘图引擎，内置资源库，支持多种绘图工具和完整历史记录',
    icon: '🗺️',
    link: '/features/map'
  },
  {
    id: 3,
    title: '关系图谱',
    description: '可视化关系图谱，支持头像设置，清晰展示人物关系网络',
    icon: '🕸️',
  ...
  },
  {
    id: 4,
    title: '创作辅助工具',
    description: '事序图、组织架构、词条字典、时间线等完整工具集，让创作更高效',
    icon: '✨',
