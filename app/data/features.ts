...
export const FEATURES: FeatureDetail[] = [
  ...
  },
  {
    ...
    description: '章节纯文本、笔记富文本（含表格）；一层子笔记本、全书搜索、导入文稿、自动保存与校对',
    features: [
      '每本书独立窗口，可同时打开多本对照写作',
      '章节为纯文本写作，笔记为富文本（标题、列表、表格、粗斜体等）',
      '笔记可插入表格，支持调整列宽、换行，以及右键增删行列',
      '笔记树：一级笔记本可新建一层子笔记本；同级笔记本可拖拽排序，双击重命名',
      '笔记可在同一本一级笔记本内拖到其他子笔记本，跨本移动会提示不允许',
      '全书搜索：Ctrl/Cmd+Shift+F 检索当前书的笔记、章节与写作助手',
      '菜单栏可导入 txt / docx 文件或文件夹；当前在章节则导入章节，在笔记则导入笔记',
      '导入章节时按当前正文设置自动补上「第 N 章」前缀',
