...
const faqs = [
  {
    question: '如何安装 51码字？',
    answer: '打开下载页。Windows / macOS 按芯片下载安装包；Android 可直接下载 APK。iOS 目前仅开放内测，请到「联系我们」加 QQ 群或发邮件申请。',
  },
  {
    question: '数据是否上传云端？',
    answer: '不会自动上传云端。正文、设定与各工具数据都在你指定的书籍目录里。手机与电脑扫码同步走同一局域网，也不会经过 51码字服务器中转文稿。请定期备份整个书籍目录。',
  },
  {
    question: '软件是免费的吗？',
  ...
  {
    question: '章节和笔记有什么区别？',
    answer: '章节是纯文本写作；笔记是富文本，可插入标题、列表和表格，适合素材、灵感和设定摘录。一级笔记本可再建一层子笔记本；笔记可在同一本内拖到其他子笔记本。删除的章节或笔记会进入左下角回收站。',
  },
  {
    question: 'AI 需要什么？',
  ...
  },
  {
    question: '如何把书同步到手机？',
    answer:
      '电脑与手机连同一 Wi-Fi，在桌面端打开扫码同步，用 51码字 App 扫描即可。Android 可在下载页直接安装；iOS 请联系客服申请内测。',
  },
  {
    question: '如何记下灵感随笔？',
    answer:
  ...
  },
  {
    question: '如何使用签约评审？',
    answer:
      '打开一本书后，在写作助手点「签约评审」。至少要有 4 章正文，并已在「AI 设置」配置文本模型。可选番茄、起点、晋江或七猫，结合本书分类生成模拟责编报告。仅供参考，不能当作官方签约结论。报告不会自动保存，可用「复制报告」。',
  },
  {
...
usePageSeo({
  title: '使用指南',
  description:
    '51码字使用指南：安装、选择书籍目录、编辑器与写作助手、签约评审、灵感随笔、AI 设置与常见问题。',
  ogTitle: '51码字使用指南',
